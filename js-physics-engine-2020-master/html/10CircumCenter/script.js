...
A = new Point(0.30 * width,0.20*height,20,"cyan",true,"A");
B = new Point(0.65 * width,0.30*height,20,"red",true,"B");
C = new Point(0.45 * width,0.80*height,20,"orange",true,"C");
ab = new LinearFunction(1,1);
bc = new LinearFunction(1,1);
ca = new LinearFunction(1,1);

mAB = new Point(0,0,10,"lime",false,"mAB");
mBC= new Point(0,0,10,"lime",false,"mBC");
mCA= new Point(0,0,10,"lime",false,"mCA");
lAB = new LinearFunction(1,1);
lBC = new LinearFunction(1,1);
lCA = new LinearFunction(1,1);

circumCenter = new Point(0,0,10,"pink",false,"circumCenter");
